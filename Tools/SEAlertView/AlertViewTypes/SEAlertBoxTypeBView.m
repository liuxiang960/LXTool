...
@implementation SEAlertBoxTypeBView
...
-(void)updateViewConstraints
{
    ...
    [_btnSure mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(165.f, 39.f));
        make.centerX.equalTo(self.mas_centerX);
        make.bottom.equalTo(self.mas_bottom).offset(-22.f);
    }];
...
-(void)setTitleForBtn:(NSString *)titleForBtn{
    _titleForBtn = titleForBtn;
    [self.btnSure setTitle:titleForBtn forState:UIControlStateNormal];
}
